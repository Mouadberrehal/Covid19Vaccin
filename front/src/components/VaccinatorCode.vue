<template>
    <div class="tile is-ancestor">
        <div class="tile is-parent">
            ...
            <article class="tile is-child is-4 notification is-info">
...
@Component<VaccinatorCode>({})
export default class VaccinatorCode extends Base {
    ...
    get codeValidationLoading() {
        return this.inProgress("validateVaccinator");
    }
}
</script>
